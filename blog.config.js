...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'auto', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题
  ...
  GREETING_WORDS:
    ...
    '大自然空寂无人的所有宁静 来到我身旁坐定, 过去、现在和未来的区别只是一个顽固的、持续的幻觉, 大理石永久幻化成一个灵魂，孤独地航行在陌生的思想海洋中, 我是我行走于其中的世界，我之所见所听或所感，全部来自我自己, 现在我用沉静的目光见到，恰是那台机器脉冲的颤跳',
